...
def build_call_context(
    ...
    if _product_persona or _product_call_flow:
        ...
        dynamic_context += (
            ...
            f"- Appointment confirm hone ke baad — thank you bolo aur [HANGUP]\n"
            f"\n### Be human\n"
            ...
            f"- Fabricate mat karo. Jo nahi pata woh seedha bolo 'Yeh toh humare senior better bata payenge, unse milte hain?'\n"
        ...
        dynamic_context = (
            ...
            f"- Appointment confirm — thank you, [HANGUP]\n"
            f"\n### Be human\n"
            f"- Real salesman ho. Fabricate mat karo. Jo nahi pata bolo 'senior better batayenge'\n"
